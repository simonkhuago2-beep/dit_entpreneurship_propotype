...
class Cache {
    ...
    private $_salt = "F5Nc{Z-@!Ud%IC5FcVnRT1w1(S=,l1]dSO.`|[(F$d7,5Dr=5f?T.7Vb#&!upt),"; // <-- change before usage!
    ...
    public function __construct(string $name = "default", string $dir = "../cache/".dirname(__FILE__), string $extension = ".cache") {
