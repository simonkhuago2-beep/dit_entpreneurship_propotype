...
class User{
		...
		if(!$username && !$password && $this->exists()){
			...
			if($user){
				if($this->data()->password === Hash::make($password, $this->data()->salt ) ){
					Session::put($this->_sessionName, $this->data()->id);
					//$this->_log->create('Login', 'User ID '.$this->data()->id.' Logged in');
					...
					if($remember){
						...
						//$this->_log->create('Login', "{$this->_sessionName} Logged in.");
					}
					return true;
				}
			}
	...
	public function logout(){
		...
		//$this->_log->create('Logout', 'User ID '.$this->data()->id.' Logged out');
