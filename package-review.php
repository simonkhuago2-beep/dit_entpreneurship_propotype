...
<body>
    <div id="page-wrapper">
        ...
        <?php 
            ...
            $package = find_by_id('tours',$json->id);
        ?>
                    ...
                    <div class="main-rating table-wrapper full-width hidden-table-sms intro">
                        ...
                        <div class="table-cell col-sm-8">
                            <div class="overall-rating">
                                <h4><?php echo num_reviews_02('packages_reviews',$package->id);?> rating on this package.</h4>
                                <?php $avag = cal_package_ratings('packages_reviews',$package->id); ?>
    ...
    <script type="text/javascript">
        ...
        (function($){
            ...
            $(document).on('submit', '#frmReview', function(){
                ...
                $.ajax({
                    type : 'POST',
                    url  : 'ajax/controller.php?type=sendPackageReview',
                    data : data,
