            ...
            <div class="search-box-wrapper">
                <div class="search-box container">
                    <ul class="search-tabs clearfix">
                        <li class="active"><a href="#hotels-tab" data-toggle="tab">APARTHOTELS</a></li>
                    ...
                    <div class="visible-mobile">
                        <ul id="mobile-search-tabs" class="search-tabs clearfix">
                            <li class="active"><a href="#hotels-tab">APARTHOTELS</a></li>
                                                ...
                                                <div class="col-xs-6">
                                                    <div class="selector">
                                                        <select class="full-width" name="drop_off">
                                                            <option value="0">Select</option>
                                                            <?php $point_pick = DB::getInstance()->query("SELECT DISTINCT drop_off, vehicle_type FROM transfers "); 
                                                                foreach($point_pick->results() as $key => $value): ?>
                ...
                <div class="row image-box style4">
                    <div class="col-sm-4">
                        <article class="box animated" data-animation-type="fadeInLeft" data-animation-delay="0">
                            <figure>
                                ...
                                <a title="" href="#" class=""><img width="370" style="height:172px" alt="" src="res/images/deal.jpg"><span class="discount"><span class="discount-text">10% Discount</span></span></a>
                            </figure>
                            <div class="details">
                    ...
                    <div class="col-sm-4">
                        <article class="box animated" data-animation-type="fadeInLeft" data-animation-delay="0.3">
                            <figure>
                                <a title="" href="#" class=""><img width="370" style="height:172px" alt="" src="res/images/promo.jpg"><span class="discount"><span class="discount-text">10% Discount</span></span></a>
                            </figure>
                            <div class="details">
                    ...
                    <div class="col-sm-4">
                        <article class="box animated" data-animation-type="fadeInLeft" data-animation-delay="0.6">
                            <figure>
                                <a title="" href="#" class=""><img width="370" style="height:172px" alt="" src="res/images/Special-offer.jpg"></a>
                            </figure>
                            <div class="details">
            ...
            <div class="global-map-area section parallax" data-stellar-background-ratio="0.5">
                <div class="container">
                    <div class="description text-center">
                        ...
                        <p style="color:#fff">Preview of our featured and preferred Aparthotels sure to meet your accommodation need</p>
                    </div>
                    <div class="image-carousel style3 flex-slider" data-item-width="170" data-item-margin="30">
                        <ul class="slides image-box style9">
                            <?php 
                                ...
                                $buffer = DB::getInstance()->query("SELECT * FROM clients WHERE groups = 4 AND verified = 1 ORDER BY id DESC LIMIT 6");
                                    if($buffer->count()){
                            ...
                            <li>
                                <article class="box">
                                    <figure>
                                        <a href="hotel-detailed.php?hotel=<?php echo $htl->id.'&from='.$today.'&to='.$tomrw.'&adult=1&infant=1&room=1';?>" title="" class="">
                                            <img src="<?php echo $path ?>" alt="hotel-img" style='height:160px ' />
                                        </a>
                                    </figure>
                                    <div class="details">
                                        <h4 class="box-title" style="text-transform:capitalize!important;"><?php  echo substr($htl->company_name, 0,15 );?>..<!-- <small>(<?php echo num_reviews($htl->id); ?> reviews)</small> --></h4>
                                        <a href="hotel-detailed.php?hotel=<?php echo $htl->id.'&from='.$today.'&to='.$tomrw.'&adult=1&infant=1&room=1';?>" title="" class="button">MORE</a>
                                    </div>
                                </article>
                            </li>
                            <?php } }?>
                    ...
                    <div class="col-sms-6 col-sm-6 col-md-3">
                        ...
                        <article class="box">
                            <figure class="animated" data-animation-type="fadeInDown" data-animation-duration="2">
                                <a href="cruise-detailed.php?id=<?php echo $excu->id.'&date='.$today.'&kids=1'; ?>" title="" class="">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="icon-box style6 animated" data-animation-type="slideInLeft" data-animation-delay="0">
                            ...
                            <div class="description">
                                ...
                                <p>Designed to serve travel agencies and the walk-in user. Be sure to receive deals and special packages whether B2B or B2C user.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="icon-box style6 animated" data-animation-type="slideInDown" data-animation-delay="0.6">
                            ...
                            <div class="description">
                                ...
                                <p>No need to be book from several sites for the same journey. Book all services on one platform and be assure of a well-coordinated services delivery.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="icon-box style6 animated" data-animation-type="slideInDown" data-animation-delay="0.9">
                            ...
                            <div class="description">
                                ...
                                <p>Get cheaper, discounted rates and the best deals on all services. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="icon-box style6 animated"  data-animation-type="slideInRight" data-animation-delay="1.2">
                            ...
                            <div class="description">
                                ...
                                <p>Secured Payment with Visa, Master Card, Bank Transfer, Debit Card, Paypal and Mobile Money</p>
                            </div>
                        </div>
                    </div>
                </div>
