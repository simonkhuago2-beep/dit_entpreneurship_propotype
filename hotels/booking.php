...
<html>
  <head>
    ...
    <title>CCTECH | Booking Management</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                        ...
                        <div class="box box-primary" >
                            ...
                            <div class="box-body">
                                <table id="example2" class="table table-bordere table-hover">
                                    <thead>
                                      <tr>
                                        <th>Client</th><th>Room Type</th>
                                        <th>No. of Persons</th><th>Arrival Date</th>
                                        <th>Departure Date</th><th style="width:200px">Special Request</th>
                                        <th>Total Bill Due</th><th></th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                      <?php 
                                            ...
                                            ?>
                                                <tr id="<?php echo $value->id ?>">
                                                    <td>
                                                        ...
                                                        <h5><?php echo $bookingDetails->email ?>, <?php echo $bookingDetails->tel ?></h5>
                                                    </td>
                                                    <td>
                                                        <h4><?php echo $room->name; ?></h4> <?php echo $room->meal_plan; ?>
                                                    </td>
                                                    <td><?php echo $bookingDetails->adult; ?> Adults <br><?php echo $bookingDetails->child; ?> Child</td>
                                                    <td><?php echo $bookingDetails->checkin; ?></td>
                                                    <td><?php echo $bookingDetails->checkout; ?></td>
                                                    <td><?php echo $bookingDetails->request; ?></td>
                                                    <td><?php echo $value->trans_cost ?></td>
                                                    <td>
                                                        <div class="btn-group">
                                                          <!-- <a href="#" class="edit btn btn-sm btn-warning"><i class="fa-edit fa"></i></a> -->
                                                          <a href="javascript:del('<?php echo $value->id?>','<?php echo $value->trans_type?>')" class="btn btn-sm btn-danger"><i class="fa-trash-o fa"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                        <?php   }
        ...
        <script>
          var link = document.getElementById('booking').className='active';
