                            ...
                            <div class="intro small-box table-wrapper full-width hidden-table-sms">
                                <div class="col-sm-4 table-cell travelo-box">
                                    <dl class="term-description">
                                        ...
                                        <dt>Citys:</dt><dd>Accra</dd>
                                        <dt>Sex:</dt><dd>Male</dd>
                                        <dt>Rate/Group:</dt><dd>$534</dd>
                                        <dt>Rate/Person</dt><dd>3 Days</dd>
                                ...
                                <div class="col-sm-8 table-cell">
                                    <div class="detailed-features">
                                        <div class="price-section clearfix">
                                            <div class="details">
                                                <h4 class="box-title">Availabilty<small>Daily</small></h4>
                                            </div>
                                            <div class="details">
                                        ...
                                        <div class="flights table-wrapper">
                                            <div class="table-row">
                                                <div class="table-cell">
                                                    <h4 class="box-title">Guide Category<small>Cultural</small></h4>
                                                </div>
                                                <div class="table-cell">
                                                    <i class="icon soap-icon-plane-right take-off"></i>
                                                    <dl><dt>Special Interest</dt><dd>Day Tours</dd></dl>
                                                </div>
                                                <div class="table-cell">
                                                    <i class="icon soap-icon-plane-right landing"></i>
                                                    <dl><dt>Special Interest</dt><dd>Group Tours</dd></dl>
                                                </div>
                                            </div>
                                            <div class="table-row">
                                                <div class="table-cell">
                                                    <h4 class="box-title">Qualification<small>Certificate</small></h4>
                                                </div>
                                                <div class="table-cell">
                                                    <i class="icon soap-icon-plane-right take-off"></i>
                                                    <dl><dt>Experience</dt><dd>4 yrs</dd></dl>
                                                </div>
                                                <div class="table-cell">
                                                    <i class="icon soap-icon-plane-right landing"></i>
                                                    <dl><dt>Age Range</dt><dd>20 - 30</dd></dl>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
