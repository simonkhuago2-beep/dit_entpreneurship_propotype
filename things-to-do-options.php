        ...
        <div class="page-title-container">
                <div class="container">
                    <div class="page-title pull-left">
                        <h2 class="entry-title">Thing to Do</h2>
                    </div>
                    <ul class="breadcrumbs pull-right">
                        <li><a href="index.php">HOME</a></li>
                        <li class="active">Options Results</li>
                    </ul>
                </div>
        </div>
                ...
                <div class="row">
                    <div id="main" class="col-md-9">
                        <div class="travelo-box travel-ideas">
                            ...
                            <h2 class="idea-title"><span class="index">1</span>What you Like?</h2>
                            <div class="column-5 image-box suggestions">
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Adventure</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="selected-effect">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Beaches &amp; Sun</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Casinos</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Family Fun</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">History</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Culture</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Tickets Only</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="selected-effect">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Shopping</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Cruise</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Hop-On Hop-Off</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Day-Trip</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Tourist Pass</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Night Tour</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Private</a></h4>
                                </div>
                                <div class="box">
                                    <a href="things-to-do-details.php" class="hover-effect style1">
                                        <img src="http://placehold.it/160x160" alt="" />
                                    </a>
                                    <h4 class="caption"><a href="things-to-do-details.php">Group</a></h4>
                                </div>
                            </div>
                            <a href="ttd-booking-request.php" class="button btn-medium green">INSPIRE ME NOW!</a>
                        </div>
                    </div>
                    <div class="sidebar col-md-3">
                        <div class="travelo-box contact-box">
                            ...
                            <address class="contact-details">
                                ...
                                <br>
                                <a href="ttd-booking-request.php" class="button btn-medium green">Request a Tour</a>
                            </address>
                        </div>
